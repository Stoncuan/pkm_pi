<section class="py-3"
  style="background-image: url('<?php echo base_url() ?>assets/template/template_home/images/background-pattern.jpg');background-repeat: no-repeat;background-size: cover;">
        ...
        <div class="category-carousel swiper">
          <div class="swiper-wrapper">
            <a href="index.html" class="nav-link category-item swiper-slide">
              <img src="<?php echo base_url() ?>assets/template/template_home/images/icon-vegetables-broccoli.png"
                alt="Category Thumbnail">
              <h3 class="category-title">Makan & Minum</h3>
            </a>
            <a href="index.html" class="nav-link category-item swiper-slide">
              <img src="<?php echo base_url() ?>assets/template/template_home/images/icon-vegetables-broccoli.png"
                alt="Category Thumbnail">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="section-header d-flex flex-wrap flex-wrap justify-content-between mb-5">
          ...
          <h2 class="section-title">Makan Dan Minuman</h2>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="card mb-3 p-3 rounded-4 shadow border-0">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="<?php echo base_url() ?>assets/template/template_home/images/product-thumb-11.jpg" class="img-fluid rounded" alt="Card title">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body py-0">
                      <p class="text-muted mb-0">Minuman</p>
            ...
            <div class="swiper-slide">
              <div class="card mb-3 p-3 rounded-4 shadow border-0">
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body py-0">
                      <p class="text-muted mb-0">Makan</p>
                      <h5 class="card-title">Lorem ipsum dolor sit amet.</h5>
                    </div>
                  </div>
                </div>
      ...
      <div class="col-md-12">
        ...
        <div class="bootstrap-tabs product-tabs">
          <div class="tabs-header d-flex justify-content-between border-bottom my-5">
            <h3>Makan Dan Minuman Yang Ada Di Manokwari</h3>
            <nav>
                  ...
                  <div class="product-item">
                    ...
                    <figure>
                      <a href="index.html" title="Product Title">
                        <img src="<?php echo base_url() ?>assets/template/template_home/images/thumb-bananas.png" class="tab-image">
                      </a>
                    </figure>
              ...
              <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                ...
                <div class="col">
                  <div class="product-item">
                    ...
                    <figure>
                      <a href="index.html" title="Product Title">
                        <img src="<?php echo base_url() ?>assets/template/template_home/images/thumb-cucumber.png" class="tab-image">
                      </a>
                    </figure>
                    <h3>Sunstar test Melon Juice</h3>
                    <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24"
                        class="text-primary">
                        <use xlink:href="#star-solid"></use>
                      </svg> 4.5</span>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="section-header d-flex justify-content-between">
          ...
          <h2 class="section-title">Makanan Paling Populer</h2>
        ...
        <div class="products-carousel swiper">
          <div class="swiper-wrapper">
            ...
            <div class="product-item swiper-slide">
              ...
              <figure>
                <a href="index.html" title="Product Title">
                  <img src="<?php echo base_url() ?>assets/template/template_home/images/thumb-tomatoes.png" class="tab-image">
                </a>
              </figure>
              <h3>Sunstar Fresh Melon Juice</h3>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="section-header d-flex justify-content-between">
          ...
          <h2 class="section-title">Minuman Paling Populer</h2>
        ...
        <div class="products-carousel swiper">
          <div class="swiper-wrapper">
            ...
            <div class="product-item swiper-slide">
              ...
              <figure>
                <a href="index.html" title="Product Title">
                  <img src="<?php echo base_url() ?>assets/template/template_home/images/thumb-tomatoketchup.png" class="tab-image">
                </a>
              </figure>
              <h3>Sunstar Fresh Melon Juice</h3>
              <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary">
      ...
      <div class="col-md-4">
        <article class="post-item card border-0 shadow-sm p-3">
          <div class="image-holder zoom-effect">
            <a href="#">
              <img src="<?php echo base_url() ?>assets/template/template_home/images/post-thumb-1.jpg" alt="post" class="card-img-top">
            </a>
          </div>
          <div class="card-body">
            ...
            <div class="post-header">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipi elit. Aliquet eleifend viverra enim tincidunt donec quam.
                A in arcu, hendrerit neque dolor morbi...</p>
            </div>
          </div>
        </article>
      </div>
